              ...
              {parsedMetrics.map((row, idx) => (
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p className="font-mono font-medium">{row.concurrency}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-muted-foreground text-xs">输入/输出 (tokens)</p>
                    <p className="font-mono font-medium">{row.inputLength} / {row.outputLength}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-muted-foreground text-xs">TTFT (ms)</p>
                    <p className="font-mono font-medium">{row.ttft.toFixed(2)}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-muted-foreground text-xs">TPOT (ms)</p>
                    <p className="font-mono font-medium">{row.tpot.toFixed(2)}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-muted-foreground text-xs">TPS (tokens/s)</p>
                    <p className="font-mono font-medium">{row.tokensPerSecond.toFixed(2)}</p>
                  </div>
                </div>
              ))}
            </div>
